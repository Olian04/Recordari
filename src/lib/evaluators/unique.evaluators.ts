...
export const unique: {
  ...
  [NodeType.Each]: (_eval, value, {children}) =>
    children[0] === undefined || value.reduce((res: boolean, val: any) => res && _eval(val, children[0]), true),
  [NodeType.Contains]: (_eval, value, {children}) =>
    children[0] === undefined || value.reduce((res: boolean, val: any) => res || _eval(val, children[0]), false),
  ...
  [NodeType.LikeArray]: (_eval, value, {children}) => (value.length === children.length) &&
    ArrayZip(value, children).reduce((res, [val, child]) => res && (child !== undefined) && _eval(val, child), true),
